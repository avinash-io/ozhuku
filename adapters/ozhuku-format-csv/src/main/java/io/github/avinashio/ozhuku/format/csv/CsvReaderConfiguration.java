...
/**
 * Defines configuration used by the Ozhuku CSV reader.
 */
public final class CsvReaderConfiguration {
    ...
    private CsvReaderConfiguration(
    ...
    public static CsvReaderConfiguration defaults() {
    ...
    public static final class Builder {
        ...
        public CsvReaderConfiguration build() {
            return new CsvReaderConfiguration(
                    delimiter,
                    quoteCharacter,
                    escapeCharacter,
